...
public class GroupsController : ControllerBase
{
    ...
    public async Task<ActionResult<Response<List<SchoolGroupDto>>>> GetAll() //Metodo GetAll devuelve todas las marcas y devuelve un objeto Response que contiene la lista ProductBrand
    {
